...
const CarouselTest = () => {
  return (
    <Carousel arrows infinite={false} dots={false} className="custom-carousel">
      <div>
        <h3 style={contentStyle}><img src="https://api.ryanhill.studio/screenshot-2024-05-22-at-3-05-26-pm/" style={{ height: '100%' }} alt="Your Image"/><br />
        <p>Description<br />more</p></h3>
      </div>
      <div>
